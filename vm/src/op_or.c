...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/06/04 21:39:30 by evlasov           #+#    #+#             */
/*   Updated: 2019/06/04 21:39:31 by evlasov          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../inc/vm.h"

static void		log_op_or(t_carr *c, int32_t arg1, int32_t arg2, int8_t reg)
{
	ft_printf("{cyan}[p%d {i}ch%d\e[23m]> ", c->id, c->champ->num);
	ft_printf("{I}or\e[27m %d %d r%d (%d) {0}\n", arg1, arg2, reg,
		c->reg[reg - 1]);
}
